  ...
  return (
    <>
      ...
      <nav className="bg-transparent shadow-none position-absolute ps-5 mt-5 w-100 z-index-2">
        <h6 className="text-white font-weight-bolder mb-0 ms-2">Instant-Fix all bookings</h6>
        <p className="text-light text-sm text-white mt-0 ms-2">Admin/ Bookings list</p>
      </nav>
