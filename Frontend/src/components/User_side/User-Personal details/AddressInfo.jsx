      ...
      <div className="col-12 col-xl-4 mb-4">
         <div className="card min-height-200">
            ...
            <div className="card-body p-3">
               {!userAddress.length ? (
                  <p className="text-center text-xs mb-5 mt-4"><strong className='text-sm'>Address not founded </strong><br /> please add new Address</p>
               ) : (
                     ...
                     return (
                        <li key={address?.address_id} className="list-group-item border-0 d-flex p-4 mb-2 mt-3 bg-gray-100 border-radius-lg">
                           ...
                           <div className="ms-auto text-end">
                              <button className="btn text-xs btn-outline-dark border-radius-xl p-1 px-4 me-1">Edit</button>
