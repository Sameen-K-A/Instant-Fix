...
class UserRepository {
    constructor(userModel, bookingModel, ratingModel) {
        this.userModel = (mongoose_1.Model);
        this.bookingModel = (mongoose_1.Model);
        this.ratingModel = (mongoose_1.Model);
        ...
        this.findByUser_id = async (user_id) => {
            try {
        ...
        this.accessIsTechnician = async (user_id) => {
            try {
        ...
        this.updatePassword = async (user_id, hashedNewPassword) => {
            try {
        ...
        this.updateProfileDetails = async (user_id, updatedInformation) => {
            try {
        ...
        this.getTechnicianDetails = async (technicianUserID) => {
            try {
                const result = await this.userModel.aggregate([
        ...
        this.createConnectionToChatFriends = async (user_id, technicianUser_id) => {
            try {
        ...
        this.bookTechnician = async (newBookingDetails) => {
            try {
        ...
        this.cancelBooking = async (booking_id) => {
            try {
        ...
        this.updateBookingPaymentStatus = async (booking_id, payment_status) => {
            try {
        ...
        this.updateBookingReviewAdded = async (booking_id, reviewAdded) => {
            try {
        ...
        this.addNewFeedbackToTechnician = async (technician_id, feedbackInformation) => {
            try {
        ...
        this.userIsBlocked = async (user_id) => {
            try {
                const userDetails = await this.userModel.findOne({ user_id: user_id });
